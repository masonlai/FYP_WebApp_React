...
function Step1(props) {
    ...
    const placeOfBirthChange = (e) => {
        const {value} = e.target;
        setPlaceOfBirth(value);
    };
    const lifeProfileChange = (e) => {
        const {value} = e.target;
        setLifeProfile(value);
    };
    return (
        <div style={theme}>
            <div className='form'>
                          ...
                          <span className="glyphicon glyphicon-calendar">
                            ...
                            <FormGroup>
                                ...
                                <Input type="text" name="FirstName"
                                       placeholder="First Name" value={fistName} onChange={fistNameChange} required/>
                            </FormGroup>
                            <FormGroup>
                                <Label>Last Name</Label>
                                <Input type="text" name="LastName" placeholder="Last Name"
                                       value={lastName} onChange={lastNameChange} required/>
                            </FormGroup>
                            <FormGroup>
                                <Label for="Gender">Gender</Label>
                                <Input type="select" name="Gender" id="Gender"
                                       value={gender} onChange={genderChange} required>
                                    <option value="volvo" disabled selected>Please choose</option>
                                    <option>Male</option>
                            ...
                            <FormGroup>
                                ...
                                <Input type="text" name="PlaceOfBirth" placeholder="Place of Birth"
                                       value={placeOfBirth} onChange={placeOfBirthChange} required/>
                            </FormGroup>
                            <FormGroup>
                                <Label for="Nationality">Nationality</Label>
                                <Input type="select" name="Nationality" id="Nationality"
                                       value={nationality} onChange={nationalityChange} required>
                                    <option value="volvo" disabled selected>Please choose</option>
                            ...
                            <FormGroup>
                                <Label for="lifeProfile">Life profile</Label>
                                <Input type="textarea" name="lifeProfile" value={lifeProfile}
