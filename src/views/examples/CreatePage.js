                    ...
                    <div className='createForm'>
                        ...
                        <Form>
                          ...
                          <span className="glyphicon glyphicon-calendar">
                            ...
                            <FormGroup>
                                <Label for="exampleSelectMulti">Nationality</Label>
                                <Input type="select" name="selectMulti" id="exampleSelectMulti">
                                    <option value="volvo" disabled selected>Please choose</option>
                            ...
                            <div className='selectTheme'>
                                <div className="cc-selector">
                                    <input id="leftTheme" type="radio" name="credit-card" value="leftTheme"/>
                                    <label className="drinkcard-cc leftTheme" htmlFor="leftTheme"></label>
                                    <input id="centerTheme" type="radio" name="credit-card" value="centerTheme"/>
                                    <label className="drinkcard-cc centerTheme" htmlFor="centerTheme"></label>
                                    <input id="rightTheme" type="radio" name="credit-card" value="rightTheme"/>
